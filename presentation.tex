...
\begin{enumerate}
  \item Command line
    \begin{enumerate}
      ...
      \item \texttt{git add DLW\_mastercode.do}
      \item \texttt{git status}
      \item \texttt{git commit -m adding "DLW\_mastercode.do"}
      \item \texttt{git status}
      \item \texttt{git log}
      \item \texttt{git push origin master}
      \item \texttt{git status}
  ...
  \item SmartGit user
    \begin{enumerate}
      ...
      \item Local $\rightarrow$ Commit... $\rightarrow$ ``Adding DLW\_procedure.do''
...
\begin{enumerate}
  \item Command line
    \begin{enumerate}
      ...
      \item edit lines 1 \& 2 of DLW\_mastercode.do
      \item \texttt{git add DLW\_mastercode.do}
  ...
  \item SmartGit user
    \begin{enumerate}
      \item edit lines 1 \& 13 of DLW\_mastercode.do
      \item Right click on file $\rightarrow$ Stage
...
\begin{enumerate}
  ...
  \item SmartGit user
    \begin{enumerate}
      ...
      \item Remote $\rightarrow$ Pull... $\rightarrow$ Rebase
      \item edit lines 4 \& 5 of DLW\_mastercode.do
      \item Right click on file $\rightarrow$ Stage
...
\begin{enumerate}
  \item SmartGit user
    \begin{enumerate}
      \item edit line 1 of DLW\_mastercode.do (type ``bug fox 1'' somewhere)
      \item Right click on file $\rightarrow$ Stage
      \item Local $\rightarrow$ Commit... $\rightarrow$ ``bug fix 1''
      \item edit lines 4 of DLW\_mastercode.do (type ``bug fix 2'' somewhere)
      \item Right click on file $\rightarrow$ Stage
      \item Local $\rightarrow$ Commit... $\rightarrow$ ``bug fix 2''
      \item edit lines 1 of DLW\_mastercode.do (change to ``bug fix 1'')
      \item Right click on file $\rightarrow$ Stage
