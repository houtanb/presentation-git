...
Clone
\begin{enumerate}
  \item \texttt{git clone presentation-origin-repo.git presentation-day}
  \item \texttt{cd presentation-day}
  \item \texttt{git commit -m "Initial Commit" --allow-empty}
\end{enumerate}

General Workflow
\begin{enumerate}
  \item \texttt{echo -e ``aaa bbb\\nccc'' > file1.txt}
  \item \texttt{git add file1.txt}
  \item \texttt{git commit -m ``my first file''}
  \item \texttt{git push origin master}
\end{enumerate}

Branch
\begin{enumerate}
  \item \texttt{git checkout -b dev}
  \item \texttt{echo -e ``aaa ddd\\nccc'' > file1.txt}
  \item \texttt{git add file1.txt}
  \item \texttt{git commit -m ``ddd change''}
  \item \texttt{git push origin dev}
  \item \texttt{git checkout master}
  \item \texttt{echo -e ``eee bbb\\nccc'' > file1.txt}
  \item \texttt{git add file1.txt}
  \item \texttt{git commit -m ``eee change''}
  \item \texttt{git push origin master}
\end{enumerate}

Tag
\begin{enumerate}
  \item \texttt{git checkout dev}
  \item \texttt{git tag come\_back}
  \item \texttt{git checkout master}
\end{enumerate}

Merge
\begin{enumerate}
  \item \texttt{git merge dev}
...
\begin{enumerate}
  ...
  \item \texttt{git cherry-pick -x dev}
\end{enumerate}
\end{document}
